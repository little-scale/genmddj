...
> **[Genesis Plus](https://www.bannister.org/software/gplus.htm)** (Richard Bannister's macOS port).
...
- **B** — tap = insert / edit · hold + D-pad = nudge the value (L/R small, U/D big) ·
  double-tap a SONG/CHAIN reference = mint/clone · tap on a note = audition it.

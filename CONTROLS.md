...
| **OPTIONS** | VID / SYNC / PALETTE / **CLONE** (clone depth: SLIM = share phrases, DEEP = copy them) / **AUDITION** (note-entry audition / prelisten, default ON). The song library moved to its own FILES screen — C+Down from SONG |
